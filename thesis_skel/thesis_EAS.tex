...
\begin{figure}[t!]
    \centering
    \subcaptionbox*{ \label{sub:fig:e_CC}}{\includegraphics[width=.45\linewidth]{thesis_figures/EAS/e_CC.pdf}}
    \hfill
    \subcaptionbox*{ \label{sub:fig:mu_CC}}{\includegraphics[width=.45\linewidth]{thesis_figures/EAS/mu_CC.pdf}}
    \hfill
    \subcaptionbox*{ \label{sub:fig:tau_CC}}{\includegraphics[width=.45\linewidth]{thesis_figures/EAS/tau_CC.pdf}}
    \hfill
    \subcaptionbox*{ \label{sub:fig:nu_NC}}{\includegraphics[width=.45\linewidth]{thesis_figures/EAS/nu_NC.pdf}}
    \caption{Sketch of different possible interactions of UHE neutrinos in the atmosphere.}
    \label{fig:NU_EAS_channels}
\end{figure}
