...
\begin{figure}[h!]
  \centering
  \subcaptionbox{Plane wavefront assumption.\label{sub:fig:Rec_theta_CC}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Plane_fit_residual.pdf}}
  \hfill
  \subcaptionbox{Spherical wavefront assumption.\label{sub:fig:Rec_theta_NC}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Curve_fit_residual.pdf}}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{$\delta \theta_{\text{Rec}}$ comparison.\label{sub:fig:Rec_theta_CC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Theta_err_CC_comp_wnt_redcut}}
  \hfill
  \subcaptionbox{$\delta \theta_{\text{Rec}}$ for different primary energies.\label{sub:fig:Rec_theta_NC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Theta_err_CC_comp_E_wnt_redcut}}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{$\mathrm{log_{10}(E_\nu}/\text{ev})$ = 18.5, $\theta_{\text{MC}}$ = 66$^{\circ}$.\label{sub:fig:Rec_theta_CC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Efficiency_vs_X1_18_5_66.pdf}}
  \hfill
  \subcaptionbox{$\mathrm{log_{10}(E_\nu}/\text{ev})$ = 19.5, $\theta_{\text{MC}}$ = 72$^{\circ}$.\label{sub:fig:Rec_theta_NC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Efficiency_vs_X1_19_5_72}}
