...
\todo{Add comparison picture of plane and spherical fit EVeNTBrowser event}
...
\begin{figure}[h!]
  ...
  \caption{The residual dependence on energy (a), zenith angle (b) and slant depth (c) for all reconstructed simulations. The errorbars are not the errors on the mean but signify the spread of the distribution. (d) The AoP distribution for the T5 stations for the sample with new triggers (open blue histogram) and old triggers (filled red histogram) is also shown.}
  \label{fig:Res_comp}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{Comparison with old .\label{sub:fig:Rec_theta_CC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Theta_err_CC_comp_wnt_redcut}}
  \hfill
  \subcaptionbox{Effect of energy.\label{sub:fig:Rec_theta_NC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Theta_err_CC_comp_E_wnt_redcut}}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{SOme theta energy .\label{sub:fig:Rec_theta_CC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Efficiency_vs_X1_18_5_66.pdf}}
  \hfill
  \subcaptionbox{sOME THETA ENERGY.\label{sub:fig:Rec_theta_NC_comp}}{\includegraphics[width=.48\linewidth]{thesis_figures/Nu_analysis/Nu_eff/Efficiency_vs_X1_19_5_72}}
