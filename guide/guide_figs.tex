...
into your thesis directory, e.g.\ \File{mythesis}.\footnote{%
...
generate them? 
Recently I have moved to a Python package \Package{PyFeyn} (\url{https://pyfeyn.hepforge.org})
...
It is also possible to use \Package{tikz}.
...
The package \Package{hepnicename} is included by \Package{PyFeyn}.
...
\Package{PyFeyn} should work pretty much out of the box,
but may need a specific version of the \Package{pyx} package.
If you want to use the \Package{newtx} fonts, you may have to apply a patch.
...
commands inside your normal \LaTeX\ file.  Metapost\index{metapost} is
