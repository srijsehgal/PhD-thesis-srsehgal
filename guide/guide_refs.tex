...
package --- see \cref{sec:ref:mcite}.
...
etc. 
By now (written in 2015) \Package{biblatex} is rather stable,
...
\texttt{ubonn-biblatex.sty}.\footnote{%
  In the past (before version 3.0) these files were called
...
\cref{sec:ref:mcite} on how to do this with \BibTeX.
